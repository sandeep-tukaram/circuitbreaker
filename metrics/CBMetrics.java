...
public class CBMetrics {
    ...
    private Map<CircuitStateEnum, AggregateCounter> successCounters;    // Shouldn't include OPEN state.
    private Map<CircuitStateEnum, AggregateCounter> failureCounters;
